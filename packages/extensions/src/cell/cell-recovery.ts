import { InteractionPendingError, ToolCallId } from "@gent/core/extensions/api"
import { InteractionStorage, StorageError, ToolId } from "@gent/core/extensions/branch-tools"
