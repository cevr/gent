...
- Delegate independent, self-contained work to children. A child has no conversation history, so give it a complete task. Do a single lookup, edit, or command inline.
