...
- Independent work goes to children: start each with tools.call('delegate.start', { todo }), then Promise.all over tools.call('delegate.wait', handle) in the same cell. A start you never wait for reports back as a message. Single reads, searches, and edits stay inline.
