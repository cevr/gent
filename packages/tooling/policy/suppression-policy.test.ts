...
const APPROVED_SUPPRESSION_LOCATIONS = new Set<string>([
  ...
  "packages/core/src/runtime/agent/agent-runner.ts:493 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/runtime/extensions/resource-host/machine-lifecycle.ts:146 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/extensions/resource-host/machine-lifecycle.ts:147 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/runtime/extensions/spawn-machine-ref.ts:240 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/extensions/spawn-machine-ref.ts:308 eslint:@typescript-eslint/no-unsafe-type-assertion",
