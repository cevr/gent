...
const APPROVED_SUPPRESSION_LOCATIONS = new Set<string>([
  ...
  "apps/tui/src/atom-solid/registry.ts:123 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "apps/tui/src/atom-solid/registry.ts:142 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "apps/tui/src/atom-solid/registry.ts:29 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "apps/tui/src/atom-solid/solid.ts:26 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/domain/schema-tagged-enum-class.ts:135 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/schema-tagged-enum-class.ts:145 eslint:import/namespace",
  "packages/core/src/domain/schema-tagged-enum-class.ts:147 eslint:import/namespace",
  "packages/core/src/domain/schema-tagged-enum-class.ts:180 eslint:import/namespace",
  "packages/core/src/domain/schema-tagged-enum-class.ts:281 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/schema-tagged-enum-class.ts:295 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/runtime/agent/agent-runner.ts:105 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/agent/agent-runner.ts:469 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/runtime/composer.ts:172 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:185 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:187 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:189 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:191 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:193 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:195 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:197 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:216 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/src/runtime/composer.ts:281 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/src/runtime/composer.ts:281 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:290 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:293 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:295 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:297 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:309 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:310 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:320 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:334 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:347 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:358 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:360 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/composer.ts:362 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:364 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:369 eslint:@typescript-eslint/no-non-null-assertion",
  "packages/core/src/runtime/composer.ts:372 eslint:@typescript-eslint/no-non-null-assertion",
  "packages/core/src/runtime/composer.ts:381 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/composer.ts:382 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/runtime/extensions/resource-host/machine-lifecycle.ts:140 effect:anyUnknownInErrorContext:off",
  "packages/core/src/runtime/extensions/resource-host/machine-lifecycle.ts:141 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/runtime/extensions/spawn-machine-ref.ts:230 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/extensions/spawn-machine-ref.ts:298 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/storage/sqlite-storage.ts:1259 effect:strictEffectProvide:off",
  "packages/core/src/storage/sqlite-storage.ts:73 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/e2e-layer.ts:133 effect:anyUnknownInErrorContext:off",
  "packages/core/src/test-utils/e2e-layer.ts:134 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/src/test-utils/e2e-layer.ts:134 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/e2e-layer.ts:138 effect:anyUnknownInErrorContext:off",
  "packages/core/src/test-utils/e2e-layer.ts:168 effect:anyUnknownInErrorContext:off",
  "packages/core/src/test-utils/e2e-layer.ts:169 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/src/test-utils/e2e-layer.ts:169 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/e2e-layer.ts:171 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/test-utils/index.ts:112 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/index.ts:165 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/tests/extensions/claude-code-executor.test.ts:10 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:101 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:127 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:17 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:31 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:45 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:58 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:73 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/tests/extensions/claude-code-executor.test.ts:88 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/tests/extensions/helpers/actor-runtime-layer.ts:28 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/tests/extensions/helpers/actor-runtime-layer.ts:28 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/tests/runtime/scope-brands.test.ts:209 ts:@ts-expect-error",
  "packages/core/tests/runtime/scope-brands.test.ts:57 ts:@ts-expect-error",
  "packages/core/tests/runtime/scope-brands.test.ts:69 ts:@ts-expect-error",
  ...
  "packages/extensions/src/acp-agents/claude-code-executor.ts:122 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:127 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:142 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:74 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:96 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/extensions/src/acp-agents/executor.ts:72 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/executor.ts:99 eslint:@typescript-eslint/no-unsafe-type-assertion",
