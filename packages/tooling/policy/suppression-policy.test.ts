...
const APPROVED_SUPPRESSION_LOCATIONS = new Set<string>([
  ...
  "packages/core/src/runtime/extensions/spawn-machine-ref.ts:221 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/runtime/extensions/spawn-machine-ref.ts:289 eslint:@typescript-eslint/no-unsafe-type-assertion",
