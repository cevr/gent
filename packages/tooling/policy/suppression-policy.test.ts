...
const APPROVED_SUPPRESSION_LOCATIONS = new Set<string>([
  ...
  "apps/tui/src/client/context.tsx:804 eslint:@typescript-eslint/no-non-null-assertion",
  ...
  "apps/tui/src/utils/format-error.ts:59 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/domain/auth-storage.ts:319 effect:preferSchemaOverJson:off",
  "packages/core/src/domain/auth-storage.ts:327 effect:preferSchemaOverJson:off",
  ...
  "packages/core/src/domain/extension-protocol.ts:200 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:211 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:226 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:230 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:264 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:283 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:287 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:337 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:346 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/domain/extension-protocol.ts:389 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/extensions/api.ts:305 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/extensions/api.ts:319 effect:anyUnknownInErrorContext:off",
  ...
  "packages/core/src/runtime/make-extension-host-context.ts:281 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/storage/sqlite-storage.ts:1736 effect:strictEffectProvide:off",
  "packages/core/src/storage/sqlite-storage.ts:73 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/e2e-layer.ts:136 effect:anyUnknownInErrorContext:off",
  "packages/core/src/test-utils/e2e-layer.ts:137 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/src/test-utils/e2e-layer.ts:137 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/e2e-layer.ts:141 effect:anyUnknownInErrorContext:off",
  "packages/core/src/test-utils/e2e-layer.ts:171 effect:anyUnknownInErrorContext:off",
  "packages/core/src/test-utils/e2e-layer.ts:172 eslint:@typescript-eslint/no-explicit-any",
  "packages/core/src/test-utils/e2e-layer.ts:172 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/core/src/test-utils/e2e-layer.ts:174 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/tests/extensions/extension-surface-locks.test.ts:105 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:138 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:172 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:204 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:215 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:225 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:241 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:249 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:288 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:290 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:292 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:294 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:305 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:307 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:309 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:318 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:326 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:350 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:352 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:354 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:356 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:358 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:371 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:386 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:397 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:405 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:411 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:478 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:510 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:555 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:67 ts:@ts-expect-error",
  "packages/core/tests/extensions/extension-surface-locks.test.ts:91 ts:@ts-expect-error",
  ...
  "packages/core/tests/extensions/openai-extension-driver.test.ts:269 effect:strictEffectProvide:off",
  ...
  "packages/extensions/src/acp-agents/claude-code-executor.ts:107 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:133 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:138 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:153 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/claude-code-executor.ts:84 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/extensions/src/acp-agents/executor.ts:108 eslint:@typescript-eslint/no-unsafe-type-assertion",
  "packages/extensions/src/acp-agents/executor.ts:82 eslint:@typescript-eslint/no-unsafe-type-assertion",
