...
const APPROVED_SUPPRESSION_LOCATIONS = new Set<string>([
  ...
  "packages/core/src/domain/auth-storage.ts:305 effect:preferSchemaOverJson:off",
  "packages/core/src/domain/auth-storage.ts:313 effect:preferSchemaOverJson:off",
  ...
  "packages/core/src/runtime/make-extension-host-context.ts:272 eslint:@typescript-eslint/no-unsafe-type-assertion",
  ...
  "packages/core/src/storage/sqlite-storage.ts:1717 effect:strictEffectProvide:off",
