...
// of a TUI module (9 total): the client provider, the extension host, a host
// utility, the facet module by path, a type import, a re-export, a dynamic
// import, `typeof import`, and a sibling client extension, which only the
// builtin roster may name.
...
export const values = [useClient, useExtensionUI, truncate, clientCommandContribution, agents]
