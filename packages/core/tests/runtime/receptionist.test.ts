...
describe("Receptionist", () => {
  test("registration roundtrip — find returns the registered ref", async () => {
  ...
  test("find on missing key returns empty array", async () => {
  ...
  test("concurrent registers do not drop entries", async () => {
  ...
  test("subscribe emits a fresh snapshot on register and unregister", async () => {
