...
export const CellTool = tool({
  ...
  promptGuidelines: [
    ...
    "console output, process.stdout and process.stderr writes, and inherited output of processes spawned during the cell return with its result, before the value of the last expression.",
